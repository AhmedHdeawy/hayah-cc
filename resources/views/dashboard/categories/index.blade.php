    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.categories.create') }}" class="btn btn-success btn-create {{ LaravelLocalization::getCurrentLocaleDirection() == 'rtl' ? 'pull-left' : 'pull-right' }}">
            ...
            <table class="table table-bordered table-striped table-condensed">
                ...
                <tbody>
                    ...
                    <tr class="text-sm-center">
                        ...
                        <td>
                            @if($loop->first)
                                <img src="{{ $category->image_url }}" width="80px" class="img-thumbnail">
                            @endif
                        </td>
