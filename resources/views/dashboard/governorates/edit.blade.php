...
@section('breadcrumb')
  ...
  <li class="breadcrumb-item"><a href="{{ route('admin.governorates.index') }}"> {{ __('dashboard.governorates') }} </a></li>
...
@section('content')
  ...
  <form action="{{ route('admin.governorates.update', $governorate->id) }}" method="post" class="form-horizontal " enctype="multipart/form-data">
    @method('PUT')
    @csrf
