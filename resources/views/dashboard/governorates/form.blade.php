...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        @php
        $status = old('status', isset($governorate) ? $governorate->status : 1);
        @endphp
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        <textarea type="text" id="{{ $languag->locale }}[name]" name="{{ $languag->locale }}[name]"
            ...
            placeholder="{{ __('dashboard.name') }}">{{ old($languag->locale .'name', isset($governorate) ? $governorate->translate($languag->locale)->name : '') }}</textarea>
