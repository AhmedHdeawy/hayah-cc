...
@section('content')
  ...
  <form action="{{ route('admin.center-branches.update', $centerBranch->id) }}" method="post" class="form-horizontal " enctype="multipart/form-data">
    @method('PUT')
    @csrf
    ...
    <div class="card">
      ...
      <div class="card-block">
          @csrf
          @include('dashboard.center-branches.form')
      </div>
